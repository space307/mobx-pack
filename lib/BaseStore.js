...
function () {
  function BaseStore(context) {
    ...
    _initializerDefineProperty(this, "serviceStatus", _descriptor, this);

    _initializerDefineProperty(this, "serviceReady", _descriptor2, this);

    _initializerDefineProperty(this, "serviceWasStarted", _descriptor3, this);
  ...
  return BaseStore;
}(), _class2.instance = null, _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "serviceStatus", [_mobx.observable], {
  configurable: true,
  enumerable: true,
  writable: true,
