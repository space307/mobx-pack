...
function ConnectorF(Component) {
  ...
  return (0, _mobxReact.observer)((_temp2 = _class = function (_React$Component) {
    ...
    _createClass(Connector, [{
      ...
      value: function render() {
        if (this.options.wairForServices && !this.servicesLoaded) {
          return typeof this.options.preLoader === 'function' ? _react2.default.createElement(this.options.preLoader, null) : this.options.preLoader;
        }
    ...
    return Connector;
  }(_react2.default.Component), _class.displayName = Component.displayName && Component.displayName + 'Connector' || Component.name + 'Connector', _class.childContextTypes = {
