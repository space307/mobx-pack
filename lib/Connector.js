...
function ConnectorF(Component) {
  ...
  function (_React$Component) {
    ...
    function Connector() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "servicesLoaded", false);

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "options", {});

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentId", '');

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "apiResolved", null);

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "storeInitializator", false);

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "store", null);
    ...
    return Connector;
  }(_react.default.Component), _defineProperty(_class, "displayName", Component.displayName && "".concat(Component.displayName, "Connector") || "".concat(Component.name, "Connector")), _defineProperty(_class, "childContextTypes", {
