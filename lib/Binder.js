  ...
  _createClass(Binder, [{
    ...
    value: function notifyOnBind(store) {
      ...
      if (store.options.onBind) {
        store.options.onBind.forEach(function (onBindItem) {
          var bindCnt = 0;
          var storeList = [];
            ...
            Object.defineProperty(to.store, toVarName, {
              get: function get() {
                if (_this3.isDebug(to.bindAs)) {
                  _this3.showMessage('Variable "' + fromVarName + '" from "' + from.bindAs + '" \n              was taken by "' + to.bindAs + '" with name "' + toVarName + '"');
                }
    ...
    value: function unbind(bindAs) {
      ...
      if (storeSettings.options.importData) {
        _lodash2.default.each(storeSettings.options.importData, function (importData) {
